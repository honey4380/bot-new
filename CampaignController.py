...
class CampaignController:
    ...
    def _checkWithdrawExist(self, userData,days:int=1,controlAfterDeposit:bool=False, hasWithdraw:bool=False,  controlMinDepositDiff:float=None, controlHourCount:int=24):
        ...
        try:
            ...
            if hasWithdraw and controlMinDepositDiff:
                return self._returnError("Tek bir kontrol parametresi belirtildir: hasWithdraw veya minDepositDiff için sağlanmalı kontrol")
